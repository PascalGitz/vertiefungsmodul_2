...
\\[12pt]
 ...
 &f_{su_{SV14}} &= 657.0\ \frac{\mathrm{N}}{\mathrm{mm}^{2}} \; 
\\[12pt]
 \theta_{c3_{SV14}} &= 23.5\ \mathrm{°} \;
\end{aligned}
$$

$$
\begin{aligned}
A_{sw_{SV14}} &= 2 \cdot \left( \frac{ \oslash_{sw_{SV14}} }{ 2 } \right) ^{ 2 } \cdot \pi  = 2 \cdot \left( \frac{ 4.3\ \mathrm{mm} }{ 2 } \right) ^{ 2 } \cdot 3.1 &= 29.0\ \mathrm{mm}^{2}  
\\[12pt]
a_{sw_{SV14}} &= \left( \frac{ A_{sw_{SV14}} }{ S_{sw_{SV14}} } \right)  = \left( \frac{ 29.0\ \mathrm{mm}^{2} }{ 150.0\ \mathrm{mm} } \right) &= 193.6\ \frac{\mathrm{mm}^{2}}{\mathrm{m}}  
\\[12pt]
V_{Rd_{SV14}} &= \left( a_{sw_{SV14}} \cdot z_{SV14} \cdot \frac{ f_{su_{SV14}} }{ \tan \left( \theta_{c3_{SV14}} \right) } \right)  = \left( 193.6\ \frac{\mathrm{mm}^{2}}{\mathrm{m}} \cdot 359.0\ \mathrm{mm} \cdot \frac{ 657.0\ \frac{\mathrm{N}}{\mathrm{mm}^{2}} }{ \tan \left( 23.5\ \mathrm{°} \right) } \right) &= 105.0\ \mathrm{kN}  
\end{aligned}
$$

$750.3409670926505\ \mathrm{mm}$
...
$$
\begin{aligned}
\rho_{sw_{SV14}} &= \left( \frac{ a_{sw_{SV14}} }{ b_{w_{SV14}} } \right)  = \left( \frac{ 193.63\ \frac{\mathrm{mm}^{2}}{\mathrm{m}} }{ 170.00\ \mathrm{mm} } \right) &= 0.11\ \mathrm{\%}  
\end{aligned}
$$
...
Versuchsbericht {[}\citeproc{ref-sigrist_versuche_1993}{4}{]} mit dem
...
entnommen aus {[}\citeproc{ref-sigrist_versuche_1993}{4}{]}}
...
{[}\citeproc{ref-sigrist_versuche_1993}{4}{]}}
